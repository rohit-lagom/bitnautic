  ...
  return (
    <header className="absolute z-50 w-full">
      <div className="px-6 mx-auto max-w-7xl">
        <div className="mt-4 sm:mt-4 md:mt-6 lg:mt-8 rounded-2xl bg-blue-900/80 backdrop-blur-xl border border-blue-300/40 shadow-md transition-all duration-500">
